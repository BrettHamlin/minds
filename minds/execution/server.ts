...
export default createMind({
  ...
  consumes: [
    ...
    "pipeline_core/paths",
    "pipeline_core/transitions",
    "pipeline_core/signal",
    "coordination/coordination-check",
