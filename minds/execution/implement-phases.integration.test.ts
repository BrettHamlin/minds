...
import { writeJsonAtomic, readJsonFile } from "../pipeline_core"; // CROSS-MIND
import { deriveDetail } from "./status-table";
import { buildDispatchCommand } from "./phase-dispatch";
import type { ImplementPhasePlan } from "../pipeline_core/registry"; // CROSS-MIND
