...
import { getRepoRoot, readJsonFile, registryPath, validateTicketIdArg } from "./orchestrator-utils";
import type { PhaseHistoryEntry } from "../pipeline_core/registry"; // CROSS-MIND

// Re-export types for test backward compatibility
export type { PhaseHistoryEntry } from "../pipeline_core/registry"; // CROSS-MIND
