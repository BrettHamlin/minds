...
import { parseSignal, getAllowedSignals, type ParsedSignal } from "../pipeline_core/signal"; // CROSS-MIND
// TODO(WD): Direct import — replace with parent escalation when Observability becomes a full Mind in Wave D.
import { openMetricsDb, ensureRun, insertSignal, insertIntervention } from "../observability/metrics"; // CROSS-MIND

// Re-export for test backward compatibility
export { parseSignal } from "../pipeline_core/signal"; // CROSS-MIND

// ============================================================================
// Types
// ============================================================================

export type { ParsedSignal } from "../pipeline_core/signal"; // CROSS-MIND
