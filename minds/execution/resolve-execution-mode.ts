...
import { getRepoRoot, readJsonFile, validateTicketIdArg, loadPipelineForTicket } from "../pipeline_core";
import { registryPath } from "../pipeline_core/paths"; // CROSS-MIND
import { resolveMode } from "../pipeline_core/questions"; // CROSS-MIND
